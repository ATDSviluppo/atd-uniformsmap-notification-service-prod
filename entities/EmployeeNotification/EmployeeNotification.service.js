...
let EmployeeNotificationService = class EmployeeNotificationService {
    ...
    findAll() {
        return this.repo.find({
            relations: ['notificationToSends', 'notificationType'],
        });
    }
    findOne(id) {
        return this.repo.findOne({
            where: { idEmployeeNotification: id },
            relations: ['notificationToSends', 'notificationType'],
        });
    }
    create(data) {
...
exports.EmployeeNotificationService = EmployeeNotificationService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(Employeenotification_1.EmployeeNotificationClass)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], EmployeeNotificationService);
//# sourceMappingURL=EmployeeNotification.service.js.map